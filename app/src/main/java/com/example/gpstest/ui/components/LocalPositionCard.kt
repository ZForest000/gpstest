...
fun LocalPositionCard(
    ...
    Card(modifier = modifier.fillMaxWidth()) {
        Column(modifier = Modifier.padding(12.dp)) {
            Text(stringResource(R.string.local_position_title), style = MaterialTheme.typography.titleSmall)
            val statusText =
            ...
            Text(text = stringResource(R.string.local_position_status, statusText), style = MaterialTheme.typography.bodySmall)
            externalEphemerisResult?.let { result ->
                ...
                Text(externalText, style = MaterialTheme.typography.bodySmall)
            }
