...
fun com.example.gpstest.domain.model.GnssSatellite.getDisplayName(): String =
    if (this.constellation == Constellation.UNKNOWN && this.rawConstellationType != -1) {
...
fun com.example.gpstest.domain.model.SatelliteHistoryEntry.getDisplayName(): String =
    if (this.constellationName == Constellation.UNKNOWN.name && this.rawConstellationType != null && this.rawConstellationType != -1) {
        "UNK(${this.rawConstellationType})"
    } else {
